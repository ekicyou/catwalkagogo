...
namespace CatWalk.Heron.Windows {
	public static class MessageUtility {
		...
		public static DataContextMessageReceiver<TMessage> RegisterMessageReceiver<TMessage>(this FrameworkElement element, Messenger messenger, Action<TMessage, object> receiver, bool receiveDeliveredMessage = false) {
			element.ThrowIfNull("element");
			messenger.ThrowIfNull("messenger");
			receiver.ThrowIfNull("receiver");
	...
	public class DataContextMessageReceiver<TMessage> : MessageReceiver<TMessage> {
		...
		public DataContextMessageReceiver(FrameworkElement element, Messenger messenger, Action<TMessage> receiver, bool receiveDeliveredMessage = false)
			: this(element, messenger, receiver, receiveDeliveredMessage, false) {
		}

		public DataContextMessageReceiver(FrameworkElement element, Messenger messenger, Action<TMessage, object> receiver, bool receiveDeliveredMessage = false)
			: this(element, messenger, receiver, receiveDeliveredMessage, true) {
		}

		protected DataContextMessageReceiver(FrameworkElement element, Messenger messenger, Delegate receiver, bool receiveDeliveredMessage, bool receiveToken)
