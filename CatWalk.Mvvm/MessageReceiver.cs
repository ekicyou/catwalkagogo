...
namespace CatWalk.Mvvm {
	public class MessageReceiver<TMessage> : DisposableObject {
		...
		public MessageReceiver(Messenger messenger, Action<TMessage> receiver, bool receiveDeliveredMessage)
			: this(messenger, receiver, receiveDeliveredMessage, false) {
		}

		public MessageReceiver(Messenger messenger, Action<TMessage, object> receiver, bool receiveDeliveredMessage)
			: this(messenger, receiver, receiveDeliveredMessage, true) {
		}

		protected MessageReceiver(Messenger messenger, Delegate receiver, bool receiveDeliveredMessage, bool receiveToken) {
